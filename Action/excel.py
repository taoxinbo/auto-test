...
if __name__ == "__main__":
    excel_file_path = parentDirPath+r"\TestData\testdata.xlsx"
    print(excel_file_path )
    excel_obj = Excel(excel_file_path)
    #Excel("e:\\a.xlsx")
    excel_obj.set_sheet_by_name("百度搜索")
    print(excel_obj.get_current_sheet_name())
    print(excel_obj.get_all_sheet_names())
    #excel_obj.set_sheet_by_index(1)
    #print(excel_obj.get_current_sheet_name())
    print(len(list(excel_obj.get_rows_object())))
    print(excel_obj.get_rows_object())
    print(len(list(excel_obj.get_cols_object())))
    #print(excel_obj.get_row(4))
    #print(excel_obj.get_col(2))
    print(excel_obj.get_cell_value(2,1))
    excel_obj.write_cell_value(5,5,"你好！")
    excel_obj.write_cell_value(5, 6, "你好","red")
    excel_obj.write_cell_value(5, 7, "你好","green")
    excel_obj.write_current_time(5,8)