...
def send_mail():
    ...
    mail_user = "txb_1985"  # 用户名
    mail_pass = "XXXXXX"  # 口令
    sender = 'txb_1985@126.com'
    receivers = ['taoxb@fingard.com','312639004@qq.com']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
    #receivers = ['taoxb@fingard.com','qiuyh@fingard.com','txb_1985@126.com']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
    # 创建一个带附件的实例
    message = MIMEMultipart()
    message['From'] = Header("陶信波<txb_1985@126.com>", 'utf-8')
